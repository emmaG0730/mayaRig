...
//Name: ROOTSecondary_Ctrl1.ma
//Last modified: Thu, Nov 08, 2018 04:00:14 PM
//Codeset: 936
requires maya "2016";
...
createNode transform -n "ROOTSecondary_Ctrl1";
...
createNode nurbsCurve -n "ROOTSecondary_Ctrl1Shape" -p "ROOTSecondary_Ctrl1";
...
createNode nurbsCurve -n "ROOTSecondary_Ctrl12Shape" -p "ROOTSecondary_Ctrl1";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		;
	setAttr -l on -k on ".curveCheck" -type "string" "";
createNode nurbsCurve -n "ROOTSecondary_Ctrl13Shape" -p "ROOTSecondary_Ctrl1";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		;
	setAttr -l on -k on ".curveCheck" -type "string" "";
createNode nurbsCurve -n "ROOTSecondary_Ctrl14Shape" -p "ROOTSecondary_Ctrl1";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		;
	setAttr -l on -k on ".curveCheck" -type "string" "";
createNode nurbsCurve -n "ROOTSecondary_Ctrl15Shape" -p "ROOTSecondary_Ctrl1";
...
select -ne :hardwareRenderGlobals;
	...
	setAttr -k on ".shml";
	setAttr -k on ".hwel";
connectAttr "ControlsLayer.di" "ROOTSecondary_Ctrl1.do";
connectAttr "layerManager.dli[11]" "ControlsLayer.id";
// End of ROOTSecondary_Ctrl1.ma
