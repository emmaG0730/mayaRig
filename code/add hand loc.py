...
for i in range(1,4):
	mc.rename('locator'+str(i),'thumb'+str(i))
for i in range(4,8):
	mc.rename('locator'+str(i),'index'+str(i))
for i in range(8,12):
	mc.rename('locator'+str(i),'middle'+str(i))
	mc.move(handLocPos+
for i in range(12,16):
	mc.rename('locator'+str(i),'ring'+str(i))	
for i in range(16,20):
	mc.rename('locator'+str(i),'pinkie'+str(i))



mc.select('thumb1')
thumb1Pos = mc.xform(q=True,ws=True,t=True)
mc.joint(n = 'thumb1JNT',p=(thumb1Pos[0],thumb1Pos[1],thumb1Pos[2]),rad = 0.3)

#proportyion  head = 20cm
